...
namespace BackgroundDynamic.Common.Helpers.Pinvoke {
#pragma warning disable CA1707, CA1401, CA1712
    public static class NativeMethods {
        ...
        /// <returns>
        ///     <c>true</c> if the operation succeedes, <c>false</c> otherwise. To get extended error information, call
        ...
        ///     the return value is <see cref="System.IntPtr.Zero" />.
        /// </returns>
        ...
        /// </returns>
        /// <remarks>
        ///     An application must not delete a DC whose handle was obtained by calling the <c>GetDC</c> function. Instead,
        ///     it must call the <c>ReleaseDC</c> function to free the DC.
        /// </remarks>
        ...
        ///     <para>
        ///         If an error occurs and the selected object is not a region, the return value is <c>NULL</c>. Otherwise, it is
        ///         <c>HGDI_ERROR</c>.
        ///     </para>
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         This function returns the previously selected object of the specified type. An application should always
        ...
        public static extern IntPtr PostMessageW(IntPtr hWnd, int Msg, IntPtr wParam, IntPtr lParam);

        [DllImport("User32.dll", EntryPoint = "PostMessageW", CallingConvention = CallingConvention.Winapi,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr PostMessageW(IntPtr hWnd, int Msg, IntPtr wParam, UIntPtr lParam);
