...
namespace BackgroundDynamic {
    public partial class MainWindow : Window {
        ...
        private void notify_init() {
            ...
            System.Windows.Forms.MenuItem backgroundsettings = new System.Windows.Forms.MenuItem("Settings");
            backgroundsettings.Click += new EventHandler(Settings_Handle);
            mute.Click += Mute_Click_Handle;
            System.Windows.Forms.MenuItem[] children = new System.Windows.Forms.MenuItem[] { backgroundsettings, playpause, mute, autostartup, delstartup, exit };
